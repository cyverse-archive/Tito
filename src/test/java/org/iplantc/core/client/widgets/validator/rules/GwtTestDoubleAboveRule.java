...
public class GwtTestDoubleAboveRule extends GWTTestCase {

    @Test
    public void testValidate() {
        List<String> params = Arrays.asList("5.7"); //$NON-NLS-1$
        DoubleAboveRule rule = new DoubleAboveRule(params);
        ...
        assertNull(rule.validate(tbl, "testField1", "5.8")); //$NON-NLS-1$ //$NON-NLS-2$
        assertNotNull(rule.validate(tbl, "testField2", "5.4")); //$NON-NLS-1$ //$NON-NLS-2$
    }
