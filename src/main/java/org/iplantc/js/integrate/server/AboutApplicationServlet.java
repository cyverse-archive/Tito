 ...
 * completed.
 * 
 * @see org.iplantc.de.shared.services.AboutApplicationService
 * @author lenards, srirma
 */
public class AboutApplicationServlet extends RemoteServiceServlet implements AboutApplicationService {
     ...
     */
    private static final String RELEASE_VERSION = TitoProperties.getReleaseVersion();

    private static final String DEFAULT_BUILD_NUMBER = TitoProperties
