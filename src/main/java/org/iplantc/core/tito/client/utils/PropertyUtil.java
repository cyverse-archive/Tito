...
public class PropertyUtil {
    ...
    /**
     * Checks if the given property should be ordered in order to be used by an App at job execution. For
     * example, static text is never used at execution, but input parameters need an order on the command
     * line to be used by the App.
     * 
     * @param prop
     * @return true if the property can be used at job execution but needs an order.
     */
